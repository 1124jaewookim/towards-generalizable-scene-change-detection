...
In this work, we address these two pivotal SCD problems by proposing a novel framework (GeSCF) and a novel benchmark (GeSCD) to foster SCD research in generalizability. <ins>밑줄</ins>
